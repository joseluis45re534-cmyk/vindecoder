// U.S. states + DC — source of truth for the state-level license-plate lookup
// cluster (/license-plate-lookup/[state]) and its sitemap entries.

export interface UsState {
  slug: string; // 'california', 'new-jersey'
  name: string;
  abbr: string;
}
